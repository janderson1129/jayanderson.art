...
if ( $is_originals ) {
    $archive_eyebrow = __( 'One-of-a-kind works', 'jay-anderson-art' );
    $archive_title   = sprintf( '%s <em>%s</em>', __( 'Original', 'jay-anderson-art' ), __( 'Paintings & Drawings', 'jay-anderson-art' ) );
    $archive_desc    = __( 'Each original is a unique, one-of-a-kind work created using archival materials. Ready to hang without glass.', 'jay-anderson-art' );
} elseif ( $is_prints ) {
        ...
        <div class="archive-header__inner">
            ...
            <nav class="archive-header__tabs" aria-label="<?php esc_attr_e( 'Browse by category', 'jay-anderson-art' ); ?>">
                <a
                    ...
                    class="archive-tab <?php echo $is_originals ? 'archive-tab--active' : ''; ?>"
                >
                    <?php esc_html_e( 'Originals', 'jay-anderson-art' ); ?>
                </a>
                <a
                ...
                <?php if ( $is_shop ) : ?>
                    <a
                        ...
                        class="archive-tab archive-tab--active"
                    >
                        <?php esc_html_e( 'All Work', 'jay-anderson-art' ); ?>
                    </a>
                <?php endif; ?>
            </nav>
        ...
        <?php if ( woocommerce_product_loop() ) : ?>
            ...
            <div class="archive-grid <?php echo $is_prints ? 'archive-grid--prints' : 'archive-grid--originals'; ?>">
                ...
                while ( have_posts() ) :
                    ...
                    $is_feat    = ( $loop_index === 0 && ! $is_prints ); /* first original spans 2 rows */
                    $loop_index++;
                ?>
