<?php
/**
 * WooCommerce Single Product Template — Limited Edition Print
 *
 * Layout:
 *  1. Breadcrumb nav
 *  2. Product hero   — large image left, details right
 *       - Title, edition badge, edition size, price
 *       - Artist story / description
 *       - Specs table (including edition details)
 *       - Add to cart / sold out state
...
$edition_size   = get_field( 'edition_size', $product_id );
...
<section class="product-hero">
    ...
    <div class="product-hero__details">
        ...
        $specs = array_filter( array(
            ...
            __( 'Edition',    'jay-anderson-art' ) => $edition_size
                ? sprintf( __( 'Limited edition — %s', 'jay-anderson-art' ), $edition_size )
                : __( 'Limited Edition Print', 'jay-anderson-art' ),
            __( 'Print type', 'jay-anderson-art' ) => __( 'Archival Giclée', 'jay-anderson-art' ),
            __( 'Materials',  'jay-anderson-art' ) => __( 'Archival, Acid-Free Paper', 'jay-anderson-art' ),
        ) );
        if ( $specs ) :
        ?>
        ...
        <ul class="product-assurances">
            ...
            <li class="product-assurance">
                <span class="product-assurance__icon" aria-hidden="true">✦</span>
                <?php esc_html_e( 'Individually numbered and signed by the artist', 'jay-anderson-art' ); ?>
            </li>
            <li class="product-assurance">
                <span class="product-assurance__icon" aria-hidden="true">✦</span>
